...
async function syncVisitSubmissionExternal({ payload }) {
  ...
  const event = {
    ...
    contactName: payload.contact_person || payload.contact_name || null,
    ...
    wholesalers: payload.wholesalers || null,
    visitObservations: payload.visit_observations || null,
    competitionInfo: payload.competition_info || null,
    competitionPrices: payload.competition_prices || null,
    competitionOffers: payload.competition_offers || null,
  };
  ...
  if (!verification) {
    const [created] = await trx('pharmacy_verifications')
      .insert({
        ...
        comment: payload.notes || null,
        contact_name: payload.contact_person || payload.contact_name || null,
